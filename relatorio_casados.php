...
$result_transacoes = "SELECT * FROM cliente WHERE estado_civil='casado' OR estado_civil='casada'  ORDER BY id ";
...
// Carrega seu HTML
$dompdf->load_html('
<h1 style="text-align: center;">  Relatório Todos os Membros Casados</h1>
'. $html .'
');
